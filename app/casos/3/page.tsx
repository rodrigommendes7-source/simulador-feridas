...
>([]);
  ...
  const avaliacaoDetalhada = useMemo<AvaliacaoSecao[]>(() => {
    ...
    if (observacaoDimensoesVista) {
      observacao.pontuacao += 3;
      observacao.acertou.push("Consultaste as dimensões e extensão da ferida pós-amputação.");
    } else {
    ...
    if (perguntasFeitas.includes("posicao")) {
      ...
      dialogo.faltou.push("Faltou perguntar sobre alívio de pressão na zona do pé.");
      dialogo.justificacaoPerda.push(
        "Perdeste pontuação por não explorares alívio de pressão na zona do pé."
      );
    }
    ...
    const tratamento = calcularPontuacaoTratamentoCaso3(tratamentosSelecionados);
  ...
  const avaliacaoTexto = useMemo(() => {
    if (pontuacao >= 85) {
      return "A abordagem foi adequada. Identificaste corretamente desbridamento, controlo de infeção, gestão do exsudado e proteção da pele perilesional.";
    }

    if (pontuacao >= 70) {
      return "A abordagem foi parcialmente adequada, mas faltaram elementos importantes para otimizar a evolução da ferida.";
    }

    if (pontuacao >= 50) {
      return "A abordagem foi parcialmente adequada, mas persistem falhas na seleção e sequência terapêutica.";
    }

    return "A abordagem escolhida não foi adequada ao estado da ferida. Revê sinais de infeção, tecido desvitalizado e necessidade de controlar exsudado abundante.";
  }, [pontuacao]);
  ...
  function guardarNoHistorico() {
    ...
    const novaResolucao: HistoricoResolucao = {
      id: criarHistoricoId(),
      casoId: "caso-3",
      casoTitulo: "Caso 3 — Ferida pós-amputação com infeção",
      pontuacao,
          ...
          <div className="flex-1 rounded-[24px] border border-[#334155] bg-[#1f2937] p-4">
            ...
            <div className="mt-6 rounded-[20px] border border-[#334155] bg-[#0f172a] p-3">
              ...
              <p className="mt-1 text-[13px] leading-snug text-[#cbd5e1]">
                Selecionar abordagem adequada para controlo de infeção, gestão de exsudado, desbridamento e proteção perilesional.
              </p>
            </div>
          </div>
            ...
            <div className="flex h-full items-center justify-center">
              <div className="w-full max-w-3xl rounded-[30px] border border-[#334155] bg-[#0f172a] p-10 text-center shadow-2xl">
                ...
                <h2 className="mt-4 text-4xl font-black text-white">
                  Caso 3 — Ferida pós-amputação com infeção
                </h2>
                <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[#cbd5e1]">
                  Utente com ferida na extremidade distal do pé após amputação digital, com evolução desfavorável, exsudado abundante, odor e tecido desvitalizado visível.
                </p>
                ...
                <div className="mt-8 rounded-2xl border border-[#334155] bg-[#111827] p-5 text-left">
                  ...
                  <p className="mt-2 text-base text-white">
                    Controlar infeção local, gerir exsudado abundante, promover desbridamento e proteger pele perilesional macerada.
                  </p>
                </div>
            ...
            <>
              <div className="mb-3 rounded-[24px] border border-[#334155] bg-[#0f172a] px-5 py-3">
                <p className="text-[16px] font-bold text-[#e2e8f0]">
                  Utente com ferida pós-amputação na extremidade distal do pé. Refere dor moderada, exsudado abundante, odor presente e episódios prévios de infeção local; a zona mantém-se sob pressão frequente.
                </p>
              </div>
                        ...
                        <div className="space-y-2 pt-2">
                          {observacaoDimensoesVista && (
                            <div className="rounded-2xl border border-[#334155] bg-[#0f172a] p-3 text-[14px] font-semibold text-white">
                              ...
                              3,5 cm de comprimento × 3,0 cm de largura × 1,0 cm de profundidade.
                            </div>
                          )}
                          {observacaoExsudadoVista && (
                            <div className="rounded-2xl border border-[#334155] bg-[#0f172a] p-3 text-[14px] font-semibold text-white">
                          ...
                          {observacaoTecidoVista && (
                            <div className="rounded-2xl border border-[#334155] bg-[#0f172a] p-3 text-[14px] font-semibold text-white">
                              ...
                              50% granulação e 50% tecido desvitalizado.
                            </div>
                          )}
                          {observacaoPerilesionalVista && (
                            <div className="rounded-2xl border border-[#334155] bg-[#0f172a] p-3 text-[14px] font-semibold text-white">
