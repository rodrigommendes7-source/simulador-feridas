    ...
    variants: [
      {
        ...
        clinicalTargets: [
          ...
          goal("exudate", "Controlar o exsudado", "control-exudate", "essencial", "Sem absorcao adequada, a pele peri-ferida degrada-se e a ferida perde controlo.", { treatmentIds: ["aquacel"] }, ["gestao-exsudado"]),
      ...
      },
      {
        ...
        evaluationRules: [
          ...
          { id: "odor-support", target: "treatment", appliesToIds: ["actisorb-silver"], classification: "adequado", reason: "O controlo de odor pode ser util como complemento ao controlo microbiano.", learningTopicIds: ["antimicrobianos"] },
          { id: "betamethasone-dehiscence", target: "treatment", appliesToIds: ["betametasona"], classification: "inadequado", reason: "Betametasona desvia o plano do controlo de infeção, do exsudado e do desbridamento.", learningTopicIds: ["materiais-desadequados"] },
          { id: "bad-application-dehiscence", target: "application", appliesToIds: ["direto_seco", "compressao_forte"], classification: "inadequado", reason: "Esta técnica agrava o trauma e não respeita a deiscência.", learningTopicIds: ["materiais-desadequados"] },
        ],
        learningTopicIds: ["antimicrobianos", "gestao-exsudado", "desbridamento", "protecao-perilesional"],
    ...
    variants: [
      {
        ...
        clinicalTargets: [
          ...
          goal("exudate", "Conter o exsudado abundante", "control-exudate", "essencial", "Sem absorcao, o leito e a pele peri-ferida continuam a degradar-se.", { treatmentIds: ["aquacel", "vliwasorb"] }, ["gestao-exsudado"]),
    ...
    variants: [
      {
        ...
        clinicalTargets: [
          ...
          goal("exudate", "Escolher cobertura proporcional ao exsudado", "control-exudate", "essencial", "O plano deve acompanhar o nivel de exsudado sem excessos.", { treatmentIds: ["aquacel", "fibrosol", "allevyn"] }, ["gestao-exsudado"]),
          goal("application-cleanse", "Aplicar cobertura após limpeza e antissépsia adequadas", "cleanse-wound", "essencial", "A cobertura deve ser aplicada depois de uma preparação correta do leito.", { applicationIds: ["apos_limpeza"] }, ["decisao-clinica"]),
