...
const cases: CaseTemplate[] = [
    ...
    variants: [
      {
        ...
        observationDetails: {
          ...
          tecidos: { detail: "Granulacao viavel com areas de fibrina aderente." },
          pele_perilesional: { detail: "Pele fragil e eritematosa." },
        },
        dialogueResponses: {
        ...
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "aquacel-simples", "fibrosol", "allevyn", "colagenase", "hidrogel", "oxido-zinco", "protetor-polimero-acrilico-spray", "creme-gordo", "betametasona"],
      ...
      },
      {
        ...
        observationDetails: {
          ...
          cheiro: { detail: "Sem odor intenso." },
          tecidos: { detail: "Granulacao viavel com areas de fibrina aderente." },
          pele_perilesional: { detail: "Pele macerada e sensivel." },
        },
        dialogueResponses: {
        ...
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "aquacel-simples", "fibrosol", "allevyn", "vliwasorb", "colagenase", "hidrogel", "oxido-zinco", "protetor-polimero-acrilico-spray", "betametasona"],
        applicationOptions: ["apos_limpeza", "com_protecao_perilesional", "sem_desbridamento_agressivo", "fixacao_atraumatica", "direto_seco", "compressao_forte"],
        clinicalTargets: [
          goal("cleanse", "Fazer limpeza antes da cobertura", "cleanse-wound", "essencial", "Sem limpeza adequada, a cobertura perde coerência clínica.", { treatmentFunctions: ["cleanse"] }, ["decisao-clinica"]),
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia ajuda a preparar o leito e enquadra melhor a cobertura.", { treatmentFunctions: ["control-bioburden"] }, ["decisao-clinica", "antimicrobianos"]),
          ...
          goal("periwound", "Proteger a pele peri-ferida", "protect-periwound", "essencial", "A pele adjacente já esta comprometida.", { treatmentFunctions: ["protect-periwound"], applicationIds: ["com_protecao_perilesional"] }, ["protecao-perilesional"]),
          goal("debridement", "Preparar o leito quando há fibrina", "debridement", "adequado", "Se existe fibrina aderente, a cobertura absorvente sozinha pode ser insuficiente.", { treatmentFunctions: ["debride"] }, ["desbridamento", "tecidos-e-leito"]),
          goal("debridement-technique", "Evitar desbridamento agressivo sem indicação", "debridement", "adequado", "A preparação do leito deve respeitar o tecido viável e o contexto clínico.", { applicationIds: ["sem_desbridamento_agressivo"] }, ["desbridamento", "tecidos-e-leito"]),
          goal("offload", "Associar técnica atraumática e alívio de pressão", "offload-pressure", "adequado", "A escolha do penso deve respeitar o contexto de pressão e o tecido viável.", { applicationIds: ["fixacao_atraumatica"] }, ["decisao-clinica"]),
        ],
      ...
      },
      {
        ...
        observationDetails: {
          ...
          cheiro: { detail: "Sem odor intenso." },
          tecidos: { detail: "Fibrina superficial com tecido viavel adjacente." },
          pele_perilesional: { detail: "Pele fragil e sensivel." },
        },
        dialogueResponses: {
          dor: "Dói mais quando mexem na zona.",
          duracao: "A ferida continua sem fechar de forma satisfatoria.",
          posicao: "Fico muito tempo na mesma posição se não me ajudam.",
          pensos: "Os pensos nem sempre ficam muito humidos.",
          febre: "Não tive febre.",
          mobilidade: "Preciso de ajuda para me virar.",
        },
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "aquacel-simples", "allevyn", "colagenase", "hidrogel", "oxido-zinco", "creme-gordo", "betametasona"],
        applicationOptions: ["apos_limpeza", "com_protecao_perilesional", "sem_desbridamento_agressivo", "fixacao_atraumatica", "direto_seco", "compressao_forte"],
        clinicalTargets: [
  ...
  },
  {
    ...
    variants: [
      {
        id: "2A",
        title: "Deiscencia com suspeita de infeção local",
        ...
        observationDetails: {
          ...
          tecidos: { detail: "Granulacao fragil com fibrina superficial." },
          pele_perilesional: { detail: "Pele peri-ferida eritematosa e fragil." },
        },
        dialogueResponses: {
        ...
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "iodopovidona-solucao", "silvercel", "aquacel-ag", "aquacel-simples", "colagenase", "hidrogel", "oxido-zinco", "protetor-polimero-acrilico-spray", "betametasona"],
        applicationOptions: ["apos_limpeza", "com_protecao_perilesional", "sem_desbridamento_agressivo", "fixacao_atraumatica", "direto_seco", "compressao_forte"],
        clinicalTargets: [
          goal("cleanse", "Fazer limpeza antes da cobertura", "cleanse-wound", "essencial", "Há necessidade de limpeza local antes do restante plano.", { treatmentIds: ["cloreto-sodio-09"] }, ["decisao-clinica"]),
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia local ajuda a preparar o leito antes da cobertura.", { treatmentIds: ["octenilin-solucao-lavagem", "iodopovidona-solucao"] }, ["decisao-clinica", "antimicrobianos"]),
          goal("bioburden", "Controlar a carga microbiana", "control-bioburden", "essencial", "Os sinais do caso exigem leitura de infeção ou colonizacao crítica.", { treatmentIds: ["silvercel", "aquacel-ag"] }, ["antimicrobianos"]),
          goal("exudate", "Controlar o exsudado", "control-exudate", "essencial", "Sem absorcao adequada, a pele peri-ferida degrada-se e a ferida perde controlo.", { treatmentIds: ["aquacel-simples"] }, ["gestao-exsudado"]),
      ...
      {
        id: "2B",
        title: "Deiscencia com infeção marcada e odor",
        ...
        observationDetails: {
          ...
          tecidos: { detail: "Fibrina e tecido desvitalizado visiveis." },
        ...
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "iodopovidona-solucao", "silvercel", "aquacel-ag", "actisorb-plus-prata", "vliwasorb", "colagenase", "hidrogel", "oxido-zinco", "protetor-polimero-acrilico-spray", "betametasona"],
        applicationOptions: ["apos_limpeza", "com_protecao_perilesional", "sem_desbridamento_agressivo", "fixacao_atraumatica", "direto_seco", "compressao_forte"],
        clinicalTargets: [
          goal("cleanse", "Fazer limpeza antes da cobertura", "cleanse-wound", "essencial", "Há necessidade de limpeza local antes do restante plano.", { treatmentIds: ["cloreto-sodio-09"] }, ["decisao-clinica"]),
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia local ajuda a preparar o leito antes da cobertura.", { treatmentIds: ["octenilin-solucao-lavagem", "iodopovidona-solucao"] }, ["decisao-clinica", "antimicrobianos"]),
          goal("bioburden", "Controlar a carga microbiana", "control-bioburden", "essencial", "Nesta variante, os sinais de infeção são marcados.", { treatmentIds: ["silvercel", "aquacel-ag", "actisorb-plus-prata"] }, ["antimicrobianos"]),
          goal("exudate", "Controlar o exsudado", "control-exudate", "essencial", "Com exsudado abundante, a absorcao e parte central da conduta.", { treatmentIds: ["vliwasorb"] }, ["gestao-exsudado"]),
        ...
        evaluationRules: [
          ...
          { id: "odor-support", target: "treatment", appliesToIds: ["actisorb-plus-prata"], classification: "adequado", reason: "O controlo de odor pode ser util como complemento ao controlo microbiano.", learningTopicIds: ["antimicrobianos"] },
          { id: "betamethasone-dehiscence", target: "treatment", appliesToIds: ["betametasona"], classification: "inadequado", reason: "Betametasona desvia o plano do controlo de infeção, do exsudado e do desbridamento.", learningTopicIds: ["materiais-desadequados"] },
          { id: "bad-application-dehiscence", target: "application", appliesToIds: ["direto_seco", "compressao_forte"], classification: "inadequado", reason: "Esta técnica agrava o trauma e não respeita a deiscência.", learningTopicIds: ["materiais-desadequados"] },
        ],
        learningTopicIds: ["antimicrobianos", "gestao-exsudado", "desbridamento", "protecao-perilesional"],
      ...
      {
        id: "2C",
        title: "Deiscencia húmida com fibrina e risco de maceração",
        ...
        dialogueResponses: {
          ...
          pensos: "O penso fica muito humido e suja a pele ao lado.",
          febre: "Não tive febre marcada, mas tenho receio porque piorou.",
          mobilidade: "Consigo andar, embora com dificuldade.",
        },
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "iodopovidona-solucao", "silvercel", "aquacel-ag", "vliwasorb", "aquacel-simples", "colagenase", "oxido-zinco", "protetor-polimero-acrilico-spray", "betametasona"],
        applicationOptions: ["apos_limpeza", "com_protecao_perilesional", "sem_desbridamento_agressivo", "fixacao_atraumatica", "direto_seco", "compressao_forte"],
        clinicalTargets: [
          goal("cleanse", "Fazer limpeza antes da cobertura", "cleanse-wound", "essencial", "A limpeza continua a ser a base do plano.", { treatmentIds: ["cloreto-sodio-09"] }, ["decisao-clinica"]),
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia local ajuda a preparar o leito antes da cobertura.", { treatmentIds: ["octenilin-solucao-lavagem", "iodopovidona-solucao"] }, ["decisao-clinica", "antimicrobianos"]),
          ...
          goal("exudate", "Controlar o exsudado", "control-exudate", "essencial", "A humidade excessiva é o fator clínico dominante nesta variante.", { treatmentIds: ["aquacel-simples", "vliwasorb"] }, ["gestao-exsudado"]),
  ...
  },
  {
    ...
    slug: "3",
    shortTitle: "Caso 3",
    title: "Ferida pos-amputação com infeção",
    ...
    variants: [
      {
        ...
        observationDetails: {
          ...
          cheiro: { detail: "Odor ligeiro." },
          tecidos: { detail: "Granulacao com fibrina aderente." },
        ...
        dialogueResponses: {
          ...
          posicao: "Nem sempre consigo aliviar a pressão na zona do pe.",
        ...
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "iodopovidona-solucao", "silvercel", "aquacel-ag", "actisorb-plus-prata", "vliwasorb", "aquacel-simples", "colagenase", "hidrogel", "oxido-zinco", "protetor-polimero-acrilico-spray", "urgotul", "betametasona"],
        applicationOptions: ["apos_limpeza", "com_protecao_perilesional", "sem_desbridamento_agressivo", "fixacao_atraumatica", "direto_seco", "compressao_forte"],
        clinicalTargets: [
          goal("cleanse", "Fazer limpeza antes da cobertura", "cleanse-wound", "essencial", "A limpeza local deve anteceder o restante plano.", { treatmentIds: ["cloreto-sodio-09"] }, ["decisao-clinica"]),
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia ajuda a preparar o leito antes da cobertura.", { treatmentIds: ["octenilin-solucao-lavagem", "iodopovidona-solucao"] }, ["decisao-clinica", "antimicrobianos"]),
          goal("bioburden", "Controlar a infeção local", "control-bioburden", "essencial", "A infeção local e um problema dominante do caso.", { treatmentIds: ["silvercel", "aquacel-ag"] }, ["antimicrobianos"]),
          goal("exudate", "Conter o exsudado abundante", "control-exudate", "essencial", "Sem absorcao, o leito e a pele peri-ferida continuam a degradar-se.", { treatmentIds: ["aquacel-simples", "vliwasorb"] }, ["gestao-exsudado"]),
          ...
          goal("odor", "Controlar odor com carvão quando útil", "manage-odor", "adequado", "O carvão ajuda no odor e complementa o controlo microbiano.", { treatmentIds: ["actisorb-plus-prata"] }, ["antimicrobianos"]),
          goal("periwound", "Proteger a pele macerada", "protect-periwound", "essencial", "A pele peri-ferida já esta comprometida.", { treatmentIds: ["oxido-zinco"] }, ["protecao-perilesional"]),
          goal("application-cleanse", "Aplicar cobertura após limpeza e antissépsia adequadas", "cleanse-wound", "essencial", "A cobertura deve ser aplicada depois de uma preparação correta do leito.", { applicationIds: ["apos_limpeza"] }, ["decisao-clinica"]),
          goal("application-periwound", "Proteger a pele peri-ferida", "protect-periwound", "essencial", "A técnica deve incluir proteção da pele peri-ferida.", { applicationIds: ["com_protecao_perilesional"] }, ["protecao-perilesional"]),
          goal("application-fixation", "Escolher fixação atraumática e controlo de pressão", "offload-pressure", "adequado", "A fixação deve respeitar o tecido e reduzir trauma adicional.", { applicationIds: ["fixacao_atraumatica"] }, ["decisao-clinica"]),
        ],
        evaluationRules: [
          ...
          { id: "odor-aid-a", target: "treatment", appliesToIds: ["actisorb-plus-prata"], classification: "adequado", reason: "Pode ser um complemento útil quando o odor tem relevância clínica.", learningTopicIds: ["antimicrobianos"] },
      ...
      },
      {
        ...
        observationDetails: {
          ...
          tecidos: { detail: "Granulacao parcial com tecido desvitalizado relevante." },
          pele_perilesional: { detail: "Macerada e descamativa." },
        },
        dialogueResponses: {
          ...
          posicao: "Nem sempre consigo aliviar a pressão na zona do pe.",
          pensos: "Sai muito líquido e o odor esta mais forte.",
        ...
        clinicalTargets: [
          ...
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia ajuda a preparar o leito antes da cobertura.", { treatmentIds: ["octenilin-solucao-lavagem", "iodopovidona-solucao"] }, ["decisao-clinica", "antimicrobianos"]),
          goal("bioburden", "Controlar a infeção local", "control-bioburden", "essencial", "A infeção local e um problema dominante do caso.", { treatmentIds: ["silvercel", "aquacel-ag"] }, ["antimicrobianos"]),
          goal("exudate", "Conter o exsudado abundante", "control-exudate", "essencial", "Sem absorcao, o leito e a pele peri-ferida continuam a degradar-se.", { treatmentIds: ["vliwasorb"] }, ["gestao-exsudado"]),
          goal("debridement", "Preparar o leito perante tecido não viável", "debridement", "essencial", "A preparação do leito deve acompanhar o controlo de infeção.", { treatmentIds: ["colagenase"] }, ["desbridamento"]),
          goal("periwound", "Proteger a pele macerada", "protect-periwound", "essencial", "A pele peri-ferida já esta comprometida.", { treatmentIds: ["oxido-zinco"] }, ["protecao-perilesional"]),
          goal("odor", "Controlar odor clinicamente relevante", "manage-odor", "adequado", "O odor orienta conforto e leitura de carga microbiana, sem substituir o plano principal.", { treatmentIds: ["actisorb-plus-prata"] }, ["antimicrobianos"]),
          goal("application-cleanse", "Aplicar cobertura após limpeza e antissépsia adequadas", "cleanse-wound", "essencial", "A cobertura deve ser aplicada depois de uma preparação correta do leito.", { applicationIds: ["apos_limpeza"] }, ["decisao-clinica"]),
          goal("application-periwound", "Proteger a pele peri-ferida", "protect-periwound", "essencial", "A técnica deve incluir proteção da pele peri-ferida.", { applicationIds: ["com_protecao_perilesional"] }, ["protecao-perilesional"]),
          goal("application-fixation", "Escolher fixação atraumática e controlo de pressão", "offload-pressure", "adequado", "A fixação deve respeitar o tecido e reduzir trauma adicional.", { applicationIds: ["fixacao_atraumatica"] }, ["decisao-clinica"]),
        ],
        evaluationRules: [
          { id: "silver-combo", target: "treatment", appliesToIds: ["silvercel", "aquacel-ag"], classification: "redundante", reason: "Usar dois absorventes com prata no mesmo plano tende a acrescentar redundância e não mais foco clínico.", learningTopicIds: ["materiais-desadequados", "antimicrobianos"] },
          { id: "hydrogel-amputation", target: "treatment", appliesToIds: ["hidrogel"], classification: "inadequado", reason: "O hidrogel agrava o excesso de humidade num caso com exsudado abundante e maceração.", learningTopicIds: ["gestao-exsudado"] },
          { id: "odor-aid", target: "treatment", appliesToIds: ["actisorb-plus-prata"], classification: "adequado", reason: "Pode ser um complemento útil quando o odor é clinicamente relevante.", learningTopicIds: ["antimicrobianos"] },
          { id: "betamethasone-amputation", target: "treatment", appliesToIds: ["betametasona"], classification: "inadequado", reason: "Betametasona não aborda o problema dominante deste coto infetado.", learningTopicIds: ["materiais-desadequados"] },
          { id: "bad-application-amputation", target: "application", appliesToIds: ["direto_seco", "compressao_forte"], classification: "inadequado", reason: "A secura e a compressão forte agravam o trauma e não respeitam o leito do coto.", learningTopicIds: ["materiais-desadequados"] },
        ],
        learningTopicIds: ["antimicrobianos", "gestao-exsudado", "desbridamento", "protecao-perilesional"],
      ...
      {
        id: "3C",
        title: "Coto humido com fibrina persistente",
        ...
        observationDetails: {
          ...
          exsudado: { detail: "Abundante." },
          cheiro: { detail: "Odor ligeiro." },
          tecidos: { detail: "Granulacao com fibrina persistente." },
          pele_perilesional: { detail: "Macerada e descamativa." },
        },
        dialogueResponses: {
        ...
        availableTreatments: ["cloreto-sodio-09", "octenilin-solucao-lavagem", "iodopovidona-solucao", "silvercel", "aquacel-ag", "actisorb-plus-prata", "vliwasorb", "aquacel-simples", "colagenase", "hidrogel", "oxido-zinco", "protetor-polimero-acrilico-spray", "betametasona"],
        applicationOptions: ["apos_limpeza", "com_protecao_perilesional", "sem_desbridamento_agressivo", "fixacao_atraumatica", "direto_seco", "compressao_forte"],
        clinicalTargets: [
          goal("cleanse", "Fazer limpeza antes da cobertura", "cleanse-wound", "essencial", "A limpeza local deve anteceder o restante plano.", { treatmentIds: ["cloreto-sodio-09"] }, ["decisao-clinica"]),
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia ajuda a preparar o leito antes da cobertura.", { treatmentIds: ["octenilin-solucao-lavagem", "iodopovidona-solucao"] }, ["decisao-clinica", "antimicrobianos"]),
          ...
          goal("debridement", "Preparar o leito perante tecido não viável", "debridement", "essencial", "A preparação do leito deve acompanhar o controlo de infeção.", { treatmentIds: ["colagenase"] }, ["desbridamento"]),
          goal("periwound", "Proteger a pele macerada", "protect-periwound", "essencial", "A pele peri-ferida já esta comprometida.", { treatmentIds: ["oxido-zinco"] }, ["protecao-perilesional"]),
          goal("odor", "Controlar odor com carvão quando útil", "manage-odor", "adequado", "O carvão complementa o controlo microbiano e o conforto.", { treatmentIds: ["actisorb-plus-prata"] }, ["antimicrobianos"]),
          goal("application-cleanse", "Aplicar cobertura após limpeza e antissépsia adequadas", "cleanse-wound", "essencial", "A cobertura deve ser aplicada depois de uma preparação correta do leito.", { applicationIds: ["apos_limpeza"] }, ["decisao-clinica"]),
          goal("application-periwound", "Proteger a pele peri-ferida", "protect-periwound", "essencial", "A técnica deve incluir proteção da pele peri-ferida.", { applicationIds: ["com_protecao_perilesional"] }, ["protecao-perilesional"]),
          goal("application-fixation", "Escolher fixação atraumática e controlo de pressão", "offload-pressure", "adequado", "A fixação deve respeitar o tecido e reduzir trauma adicional.", { applicationIds: ["fixacao_atraumatica"] }, ["decisao-clinica"]),
        ],
    ...
    variants: [
      {
        ...
        observationDetails: {
          ...
          cheiro: { detail: "Sem odor intenso." },
          tecidos: { detail: "Granulacao viavel com fibrina superficial." },
          pele_perilesional: { detail: "Pele integra com sensibilidade local." },
        },
        dialogueResponses: {
          dor: "Dói sobretudo durante o penso.",
          duracao: "A lesão já dura várias semanas.",
          posicao: "Passo muito tempo em pe e com o membro em declive.",
        ...
        clinicalTargets: [
          ...
          goal("exudate", "Escolher cobertura proporcional ao exsudado", "control-exudate", "essencial", "O plano deve acompanhar o nivel de exsudado sem excessos.", { treatmentIds: ["aquacel-simples", "fibrosol", "allevyn"] }, ["gestao-exsudado"]),
          goal("application-cleanse", "Aplicar cobertura após limpeza e antissépsia adequadas", "cleanse-wound", "essencial", "A cobertura deve ser aplicada depois de uma preparação correta do leito.", { applicationIds: ["apos_limpeza"] }, ["decisao-clinica"]),
      ...
      },
      {
        ...
        observationDetails: {
          ...
          exsudado: { detail: "Baixo, seroso." },
          cheiro: { detail: "Sem odor intenso." },
          tecidos: { detail: "Fibrina superficial e tecido viavel adjacente." },
          pele_perilesional: { detail: "Pele sensivel e fragil." },
        },
        dialogueResponses: {
          dor: "Dói sobretudo durante o penso.",
          duracao: "A lesão já dura várias semanas.",
        ...
        clinicalTargets: [
          ...
          goal("antisepsis", "Associar antissépsia local", "control-bioburden", "adequado", "A antissépsia adequada prepara o leito antes da cobertura.", { treatmentIds: ["octenilin-solucao-lavagem"] }, ["decisao-clinica", "antimicrobianos"]),
          goal("debridement", "Preparar o leito se houver fibrina", "debridement", "essencial", "A fibrina muda a prioridade clínica do caso.", { treatmentIds: ["colagenase"] }, ["desbridamento"]),
          goal("exudate", "Escolher cobertura proporcional ao exsudado", "control-exudate", "adequado", "Mesmo com humidade mais baixa, a cobertura deve ser coerente com o leito.", { treatmentIds: ["aquacel-simples", "allevyn"] }, ["gestao-exsudado"]),
          goal("application-cleanse", "Aplicar cobertura após limpeza e antissépsia adequadas", "cleanse-wound", "essencial", "A cobertura deve ser aplicada depois de uma preparação correta do leito.", { applicationIds: ["apos_limpeza"] }, ["decisao-clinica"]),
          goal("application-periwound", "Proteger a pele peri-ferida", "protect-periwound", "adequado", "A técnica deve proteger a pele adjacente.", { applicationIds: ["com_protecao_perilesional"] }, ["protecao-perilesional"]),
          goal("application-debridement", "Evitar desbridamento agressivo sem indicação", "debridement", "adequado", "A abordagem do leito deve respeitar o tecido viável.", { applicationIds: ["sem_desbridamento_agressivo"] }, ["desbridamento", "tecidos-e-leito"]),
      ...
      },
      {
        ...
        observationDetails: {
          ...
          exsudado: { detail: "Moderado, seroso." },
          cheiro: { detail: "Sem odor intenso." },
          tecidos: { detail: "Granulacao viavel predominante." },
          pele_perilesional: { detail: "Pele integra com sensibilidade local." },
        },
        dialogueResponses: {
          dor: "Dói sobretudo durante o penso.",
