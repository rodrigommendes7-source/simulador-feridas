...
export const treatmentCatalog: TreatmentDefinition[] = [
...

  {
    ...
    evidenceRefs: ["alginate-review", "wuwhs-exudate-2019"],
...

  {
    ...
    evidenceRefs: ["foam-review", "wounds-intl-autolytic-2025"],
...

  {
    ...
    evidenceRefs: ["foam-review", "silver-consensus", "aptferidas-infecao-2025"],
...

  {
    ...
    evidenceRefs: ["foam-review", "wuwhs-exudate-2019"],
    learningTopicIds: ["gestao-exsudado"],
...

  {
    ...
    evidenceRefs: ["foam-review", "skin-barrier-review", "wuwhs-exudate-2019"],
...

  {
    ...
    evidenceRefs: ["antiseptic-review-2022", "aptferidas-infecao-2025"],
    learningTopicIds: ["antimicrobianos"],
...

  {
    ...
    evidenceRefs: ["hydrofiber-review", "silver-consensus", "aptferidas-infecao-2025"],
    learningTopicIds: ["antimicrobianos", "gestao-exsudado"],
...

  {
    ...
    evidenceRefs: ["hydrofiber-review", "wuwhs-exudate-2019"],
    learningTopicIds: ["gestao-exsudado"],
...

  {
    ...
    evidenceRefs: ["honey-cochrane-2015"],
...

  {
    ...
    evidenceRefs: ["alginate-review", "silver-consensus", "aptferidas-infecao-2025"],
    learningTopicIds: ["antimicrobianos", "gestao-exsudado"],
...

  {
    ...
    evidenceRefs: ["silver-consensus", "aptferidas-infecao-2025"],
...

  {
    ...
    evidenceRefs: ["antiseptic-review-2022"],
    learningTopicIds: ["antimicrobianos"],
...

  {
    ...
    evidenceRefs: ["collagenase-review", "debridement-review", "wbp-2024"],
...

  {
    ...
    evidenceRefs: ["hydrogel-cochrane-2013", "wounds-intl-autolytic-2025"],
