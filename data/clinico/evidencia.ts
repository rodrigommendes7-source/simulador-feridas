import type { ReferenciaEvidencia } from "../../lib/clinico/types.ts";
...
export const evidenceReferences: ReferenciaEvidencia[] = [
  ...
  {
    id: "collagenase-revisao",
    titulo: "Ramundo & Gray — Collagenase for enzymatic debridement: a systematic revisao",
